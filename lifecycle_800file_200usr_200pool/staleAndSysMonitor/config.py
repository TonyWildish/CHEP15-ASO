...
config.AsyncTransfer.pool_size = 250
config.AsyncTransfer.pollInterval = 30
...
config.AsyncTransfer.pollViewsInterval = 30
...
config.DBSPublisher.publication_pool_size = 200
...
config.DBSPublisher.max_files_per_block = 30
